...
namespace Microsoft.Practices.EnterpriseLibrary.Validation.Tests.Validators
{
    ...
    public class RelativeDateTimeValidatorFixture
    {
        ...
        public void NonNegatedFailureForDateTimeUpperOnlyNegativeExclusive()
        {
            ...
            Assert.IsFalse(validator.Validate(DateTime.Now.AddDays(-5).AddSeconds(1.0)).IsValid);
            Assert.IsFalse(validator.Validate(DateTime.Now.AddDays(-2).AddSeconds(1.0)).IsValid);
            Assert.IsFalse(validator.Validate(DateTime.Now).IsValid);
            Assert.IsFalse(validator.Validate(DateTime.Now.AddDays(3).AddSeconds(1.0)).IsValid);
        }
